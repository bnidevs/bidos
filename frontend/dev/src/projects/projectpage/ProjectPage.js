...
function RepoBtn(props) {
  return (
    <a href={props.link}>
      <button className="project_footer_button">
...
function ProjectPage(props) {
  ...
  useEffect(() => {
    const t = async () => {
      fetch(
        "https://cxef3s02t6.execute-api.us-east-1.amazonaws.com/projects/search?name=" +
          props.projectName.replaceAll("_", " ")
      )
        .then((resp) => resp.json())
    ...
    <section className="project_page_main">
      ...
      <div className="left_sidebar">
        <div className="image_wrapper">
          {"logo_link" in projectData ? (
            <img src={projectData.logo_link} className="proj_img" />
          ) : (
            ""
          )}
          <div className="flex">
